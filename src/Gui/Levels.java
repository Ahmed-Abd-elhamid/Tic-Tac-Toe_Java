...
public class Levels extends AnchorPane {
    ...
    public Levels() {
        ...
        imageView5.setLayoutX(150.0);
        imageView5.setLayoutY(398.0);
        imageView5.setFitHeight(38);
        imageView5.setFitWidth(38);
        imageView5.setOpacity(0.8);
        imageView5.setPickOnBounds(true);
        imageView5.setImage(new Image(getClass().getResource("img/back.png").toExternalForm()));
